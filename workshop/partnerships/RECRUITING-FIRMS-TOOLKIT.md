# Recruiting & Staffing Firms Partnership Toolkit
...
**Subject:** A different way to engage .NET developers
...
**Subject:** Re: A different way to engage .NET developers
...
1. **You sponsor it (free to attendees)** — Maximum goodwill, maximum attendance
...
**Subject:** Workshop partnership details — [Firm Name]
...
**Format:** Hands-on coding—participants build a real API
...
┌─────────────────────────────────────────────────────────────────────────────┐
│                                                                             │
│          WORKSHOP PARTNERSHIP FOR RECRUITING FIRMS                          │
│                                                                             │
│              ASP.NET Core Modular Monolith Workshop                         │
│                                                                             │
├─────────────────────────────────────────────────────────────────────────────┤
...
│  • Traditional events don't build real relationships                        │
...
│  THE SOLUTION                                                               │
│  ────────────                                                               │
│  A full-day, hands-on technical workshop that:                              │
│                                                                             │
│  ✓ Provides genuine value developers actually want                          │
│  ✓ Creates 8 hours of meaningful interaction                                │
│  ✓ Positions your firm as a technical resource                              │
│  ✓ Builds goodwill that converts to placements                              │
│                                                                             │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
...
│  • Caching, Validation, Rate Limiting                                       │
│  • Integration Testing                                                      │
│                                                                             │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
...
│                                                                             │
│  ┌─────────────────┬─────────────────┬─────────────────┐                    │
│  │   SPONSORED     │  REVENUE SHARE  │    PREMIUM      │                    │
│  ├─────────────────┼─────────────────┼─────────────────┤                    │
│  │ Free to         │ Charge          │ Charge          │                    │
│  │ attendees       │ $199-299        │ $399-499        │                    │
│  ├─────────────────┼─────────────────┼─────────────────┤                    │
│  │ Maximum         │ Lower upfront   │ Higher revenue  │                    │
│  │ goodwill        │ cost            │ potential       │                    │
│  ├─────────────────┼─────────────────┼─────────────────┤                    │
│  │ You capture all │ Split revenue   │ Smaller, more   │                    │
│  │ registrants     │ 60/40           │ senior audience │                    │
│  ├─────────────────┼─────────────────┼─────────────────┤                    │
│  │ $3,500-5,000    │ Venue +         │ Negotiable      │                    │
│  │ investment      │ marketing only  │                 │                    │
│  └─────────────────┴─────────────────┴─────────────────┘                    │
│                                                                             │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
...
│  ──────────────────────── │ ────────────────────────                        │
│  • Venue                  │  • Complete curriculum                          │
│  • Marketing              │  • Expert instruction                           │
│  • Registration           │  • All materials                                │
...
│  ──────────                                                                 │
│                                                                             │
│  "From 22 attendees, we added 18 qualified candidates to our active         │
│   pipeline. Within 4 months, we made 3 placements directly attributed       │
│   to workshop connections—generating $45,000 in placement fees from         │
│   a $4,000 investment."                                                     │
│                                                                             │
...
│  2. Choose partnership model and date                                       │
│  3. Promote to your database (4-6 weeks)                                    │
│  4. We deliver the workshop; you work the room                              │
│  5. Nurture leads into placements                                           │
│                                                                             │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  CONTACT                                                                    │
...
│  [LinkedIn]                                                                 │
│                                                                             │
│  Ready to discuss? Schedule a call: [Calendar Link]                         │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
**Investment:** $4,000 (sponsored workshop)
**Attendance:** 20 developers
**Pipeline additions:** 16 (80%)
**Placements (6 months):** 3
