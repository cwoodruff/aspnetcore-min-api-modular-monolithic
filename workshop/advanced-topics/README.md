...
This folder contains detailed implementation guides for advanced topics that can
extend the core workshop or serve as standalone learning resources.
...
These guides are designed to work with the Modular Monolith workshop solution.
Most can be added incrementally without disrupting existing functionality.
