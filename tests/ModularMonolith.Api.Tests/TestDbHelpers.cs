...
public static class TestDbHelpers
{
    ...
    public static void SeedMinimalGraph(AppDbContext db)
    {
        ...
        var emp = new Employee { Id = 2, FirstName = "John", LastName = "Doe", Title = "Rep", ReportsTo = 1, ReportsToNavigation = mgr };
        mgr.InverseReportsToNavigation.Add(emp);
        db.Employees.AddRange(mgr, emp);

        // Customers
        var cust = new Customer { Id = 1, FirstName = "Alice", LastName = "Smith", Email = "alice@example.com", SupportRepId = 2, SupportRep = emp };
        ...
        var track1 = new Track { Id = 1, Name = "Song 1", AlbumId = 1, Album = album, GenreId = 1, Genre = genre, MediaTypeId = 1, MediaType = media, UnitPrice = 0.99m };
        var track2 = new Track { Id = 2, Name = "Song 2", AlbumId = 1, Album = album, GenreId = 1, Genre = genre, MediaTypeId = 1, MediaType = media, UnitPrice = 1.29m };
        album.Tracks.Add(track1); album.Tracks.Add(track2);
        ...
        // Invoice and lines
        var invoice = new Invoice { Id = 1, CustomerId = 1, Customer = cust, InvoiceDate = DateTime.UtcNow, Total = 2.28m };
        var il1 = new InvoiceLine { Id = 1, InvoiceId = 1, Invoice = invoice, TrackId = 1, Track = track1, UnitPrice = 0.99m, Quantity = 1 };
        var il2 = new InvoiceLine { Id = 2, InvoiceId = 1, Invoice = invoice, TrackId = 2, Track = track2, UnitPrice = 1.29m, Quantity = 1 };
